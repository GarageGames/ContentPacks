...
singleton TSShapeConstructor(Zombie_04DAE)
{
   baseShape = "./Zombie_04.DAE";
   loadLights = "0";
   upAxis = "DEFAULT";
...
function Zombie_04DAE::onLoad(%this)
{
   ...
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Idle_01.DAE", "root", "30", "150", "1", "1");
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Idle_02.DAE", "root2", "180", "300", "1", "1");
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Idle_03.DAE", "root3", "330", "450", "1", "1");
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Walk_01.DAE", "run2", "500", "590", "1", "1");
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Walk_02.DAE", "run", "620", "710", "1", "1");
