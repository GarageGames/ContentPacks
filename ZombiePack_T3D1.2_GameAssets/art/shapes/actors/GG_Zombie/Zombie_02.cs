...
singleton TSShapeConstructor(Zombie_02DAE)
{
   baseShape = "./Zombie_02.DAE";
   loadLights = "0";
   upAxis = "DEFAULT";
...
function Zombie_02DAE::onLoad(%this)
{
   ...
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Idle_01.DAE", "root2", "30", "150", "1", "1");
   %this.addSequence("art/shapes/actors/GG_Zombie/Anims/Zombie_Idle_02.DAE", "root", "180", "300", "1", "1");
   ...
   //%this.saveShape("art/shapes/actors/GG_Zombie/1_1/Zombie_02.dts");
}
